...
CRAWLER_LINKS = [
    ...
    ('/leadfluid/bt101l/', '리드플루이드 BT101L 지능형 연동펌프 — 사양·구성'),
    ('/leadfluid/bt103s/', '리드플루이드 BT103S 분주형 연동펌프 — 사양·구성'),
    ('/leadfluid/bt301l/', '리드플루이드 BT301L 지능형 유량 연동펌프 — 사양·구성'),
    ('/leadfluid/wt600f/', '리드플루이드 WT600F 분주형 대유량 연동펌프 — 사양·구성'),
    ('/leadfluid/mf106/', '리드플루이드 MF106 고보호(IP66/67) 연동펌프 — 사양·구성'),
    ('/leadfluid/bq80s/', '리드플루이드 BQ80S 마이크로 정량 연동펌프 — 사양·구성'),
    ('/leadfluid/tyd01-01/', '리드플루이드 TYD01-01 시린지펌프 — 사양·구성'),
    ('/leadfluid/tfd/', '리드플루이드 TFD 스플릿형 시린지펌프 — 사양·구성'),
    ('/leadfluid/ct3001f/', '리드플루이드 CT3001F PEEK 기어펌프 — 사양·구성'),
    ('/leadfluid/explosion-proof/', '리드플루이드 EF803 방폭 연동펌프 — 사양·구성'),
    ('/leadfluid/explosion-proof-gear/', '리드플루이드 FG601S 방폭 모터 연동펌프 — 사양·구성'),
...
def main():
    ...
    static_pages = [
        ...
        ('leadfluid/bt101l/','0.8', 'monthly'),
        ('leadfluid/bt103s/','0.8', 'monthly'),
        ('leadfluid/bt301l/','0.8', 'monthly'),
        ('leadfluid/wt600f/','0.8', 'monthly'),
        ('leadfluid/mf106/','0.8', 'monthly'),
        ('leadfluid/bq80s/','0.8', 'monthly'),
        ('leadfluid/tyd01-01/','0.8', 'monthly'),
        ('leadfluid/tfd/','0.8', 'monthly'),
        ('leadfluid/ct3001f/','0.8', 'monthly'),
        ('leadfluid/explosion-proof/','0.8', 'monthly'),
        ('leadfluid/explosion-proof-gear/','0.8', 'monthly'),
