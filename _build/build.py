...
CRAWLER_LINKS = [
    ...
    ('/brands/hench/automatic-pellet-press-hap-2s/', 'Hench HAP-2S 자동 유압 펠릿 프레스 2T — 프로그램 가압·보압·탈형'),
    ('/brands/hench/isostatic-press-yp-40j/', 'Hench YP-40J/S 수동 등정압 펠릿 프레스 40T — 등정압 챔버 내압 ≤300MPa'),
    ('/brands/hench/vacuum-hot-press-vhp-200d/', 'Hench VHP-200D 진공 자동 열압기 — 진공 챔버 가열·가압 성형'),
...
def build_all_products():
    ...
    '배터리 소재': ['배터리 재료', '분리막', 'Whatman', 'Celgard', '코인셀 케이스', '바인더', 'PVDF', '도전재', '집전체', '전해질 염', '고순도 용매'],
        ...
        'tubing': ['연동펌프 튜브', '펌프 호스', '실리콘 튜브', '펌프관', '튜브 규격', '소모품 튜브', '내화학 튜브', '위생급 튜브', '바이오 튜브', '튜브 교체'],
