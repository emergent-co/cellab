...
CRAWLER_LINKS = [
    ...
    ('/brands/leadfluid/bt101l/', '리드플루이드 BT101L 지능형 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/bt103s/', '리드플루이드 BT103S 분주형 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/bt301l/', '리드플루이드 BT301L 지능형 유량 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/wt600f/', '리드플루이드 WT600F 분주형 대유량 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/mf106/', '리드플루이드 MF106 고보호(IP66/67) 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/bq80s/', '리드플루이드 BQ80S 마이크로 정량 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/tyd01-01/', '리드플루이드 TYD01-01 시린지펌프 — 사양·구성'),
    ('/brands/leadfluid/tfd/', '리드플루이드 TFD 스플릿형 시린지펌프 — 사양·구성'),
    ('/brands/leadfluid/ct3001f/', '리드플루이드 CT3001F PEEK 기어펌프 — 사양·구성'),
    ('/brands/leadfluid/explosion-proof/', '리드플루이드 EF803 방폭 연동펌프 — 사양·구성'),
    ('/brands/leadfluid/explosion-proof-gear/', '리드플루이드 FG601S 방폭 모터 연동펌프 — 사양·구성'),
