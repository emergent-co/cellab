...
def build_all_products():
    ...
    if ok:
        ...
        CANON_TERMS = [
            # (대표 키워드, 숨은 연결어 — 이 단어로 입력해도 제안에 뜸)
            ('튜브퍼니스', '퍼니스 전기로 관상로 튜브로 소성로 열처리로 furnace'),
            ('머플로', '퍼니스 전기로 박스로 박스퍼니스 소성로 열처리로 furnace'),
            ('진공 전기로', '퍼니스 전기로 진공로 진공머플 furnace'),
            ('회전킬른', '퍼니스 전기로 로터리킬른 회전튜브로 회전로 kiln'),
            ('엘레베이터 전기로', '퍼니스 전기로 엘리베이터 furnace'),
            ('CVD', '가스플로 증착 퍼니스 전기로'),
            ('스팀 제너레이터', '스팀 steam 보일러'),
            ('열풍건조기', '건조기 오븐 드라이오븐 컨벡션 oven'),
            ('진공건조기', '건조기 오븐 진공오븐 oven'),
            ('회전증발농축기', '농축기 증발 에바포레이터 로터리 evaporator'),
            ('숏패스 증류', '증류 분별 정유'),
            ('인큐베이터', '배양기 incubator'),
            ('CO2 배양기', '인큐베이터 배양기 씨오투'),
            ('진탕배양기', '인큐베이터 배양기 쉐이킹 셰이커 진탕기'),
            ('데시케이터', '데시게이터 보관함'),
            ('항온수조', '수조 워터배스 배스 bath'),
            ('칠러', '냉각 순환수조 chiller'),
            ('항온항습기', '챔버 환경챔버 온습도 신뢰성'),
            ('오토클레이브', '멸균기 멸균 autoclave'),
            ('교반기', '스터러 믹서 stirrer'),
            ('핫플레이트', '가열교반 hotplate 교반기'),
            ('볼밀', '분쇄기 밀 mill'),
            ('행성믹서', '믹서 플래너터리 mixer'),
            ('3롤밀', '롤밀 밀 mill'),
            ('제트밀', '분쇄기 밀 mill'),
            ...
            ('흄후드', '후드 hood 배기'),
            ('클린벤치', '무균 크린벤치 벤치 bsc'),
            ('전자저울', '저울 정밀저울 balance'),
            ('수분측정기', '수분계 측정'),
            ('정량펌프', '펌프 연동펌프 페리스탈틱 튜빙 호스 pump'),
            ('시린지펌프', '펌프 주사기 실린지 syringe pump'),
            ('기어펌프', '펌프 gear pump'),
            ('방폭펌프', '펌프 방폭 atex pump'),
            ('펌프헤드', '펌프 헤드 카세트'),
            ('OEM 펌프', '펌프 모듈 내장'),
            ('질량유량계', 'mfc 유량계 매스플로우 유량 flow'),
            ('MFC', '유량계 질량유량계 매스플로우'),
            ('압력 컨트롤러', '압력 제어 pressure'),
            ('BPR', '배압 레귤레이터 압력'),
            ('기준전극', '전극 reference'),
            ('상대전극', '전극 백금 counter'),
            ('작업전극', '전극 유리탄소 working'),
            ('RHE', '수소전극 전극 가역'),
            ('RDE', '회전전극 전극 rrde 링'),
            ('전해셀', '셀 전기화학 cell'),
            ('CO2RR 촉매', '촉매 전극 co2 환원'),
            ('이온교환막', '막 멤브레인 나피온 막전극'),
            ('카본페이퍼', '카본 gdl 가스확산'),
            ('배터리 테스트 셀', '셀 배터리 코인 파우치'),
            ('삼흥에너지', '삼흥 sh scientific'),
            ('리드플루이드', 'leadfluid 리드 펌프'),
            ('Alicat', '알리캣 mfc 유량계'),
            ('가오스유니온', '가오스 gaoss 전기화학'),
        ]
        _sug = []
        for _w, _al in CANON_TERMS:
            _ws = _w.lower().split()
            _n = sum(1 for _k in all_keys if all(x in _k for x in _ws))
            if _n > 0:
                _sug.append([_w, _n, _al])
