...
CRAWLER_LINKS = [
    ...
    ('/brands/leadfluid/tfd/', '리드플루이드 TFD01-01 — 사양·가격'),
    ...
    ('/brands/leadfluid/explosion-proof/', '리드플루이드 EF800 — 사양·가격'),
    ('/brands/leadfluid/ef900/', '리드플루이드 EF900 — 사양·가격'),
    ('/brands/leadfluid/explosion-proof-gear/', '리드플루이드 FG601S-A3 — 사양·가격'),
