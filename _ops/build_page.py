...
CSS = ('<style>'
 ...
 '.sn.b{background:var(--merck)}.sn.d{background:var(--merck)}.sn.o{background:#646469}.sn.x{background:var(--danger)}'
 ...
 '.buy-box{border:1px solid var(--merck-line);border-radius:6px 12px 12px 6px;'
 'background:var(--warn-bg);padding:12px 16px;margin:10px 0 12px;font-size:13.5px;line-height:1.8;color:#3a3330}'
 '.buy-box .bt{display:block;font-weight:800;color:var(--merck-d);font-size:13px;margin-bottom:3px}'
 ...
 '.mdl-dots button.on{background:var(--merck)}'
 ...
 '.mdl-nav:hover{background:var(--merck);color:#fff;border-color:var(--merck)}'
