...
ITEMS = [('gc-disc-working-electrode', '작업전극'),
         ...
         ('glass-cell-c002',           '전해셀'),
         ('sealed-cell-c001',          '전해셀'),
         ('jacket-cell-c003',          '전해셀'),
         ('five-port-cell-c010',       '전해셀'),
         ('h-cell-ch2001',             '전해셀'),
         ('membrane-cell-ch2010',      '전해셀'),
         ('electrode-stand-t0101',     '전해셀'),
         ('cell-c040',                 '전해셀'),
         ('multifunction-cell-m005',   '전해셀'),
         ('h-cell-ch2003',             '전해셀'),
         ('membrane-cell-ch2015',      '전해셀'),
         ('photo-cell-k040',           '광전기화학 셀'),
         ('photo-reactor-k010',        '광전기화학 셀'),
         ('photo-cell-k020',           '광전기화학 셀'),
         ('photo-cell-k050',           '광전기화학 셀'),
         ('spectro-cell-k003',         '광전기화학 셀'),
         ('flat-cell-f029',            '부식 시험 셀'),
         ('corrosion-cell-f500',       '부식 시험 셀'),
         ('coating-cell-f011',         '부식 시험 셀'),
         ('raman-cell-k004',           '인시츄 라만 셀'),
         ('raman-battery-cell',        '인시츄 라만 셀'),
         ('xrd-cell-e602',             '인시츄 XRD 셀'),
         ('zinc-air-cell-e100',        '배터리 시험 셀'),
         ('battery-imaging-e001',      '배터리 시험 셀'),
         ('battery-observation-e003',  '배터리 시험 셀'),
         ('gde-cell-e023',             '배터리 시험 셀'),
         ('half-cell-e025',            '배터리 시험 셀'),
         ('battery-cell-e200',         '배터리 시험 셀')]
NM = {'gc-disc-working-electrode': 'GC120 ~ GC321',
      ...
      'glass-cell-c002':           'C002 · 10 ~ 500 mL',
      'sealed-cell-c001':          'C001 · 10 ~ 250 mL',
      'jacket-cell-c003':          'C003 · C003-S',
      'five-port-cell-c010':       'C010 · C011 · C004',
      'h-cell-ch2001':             'CH2001 · CH2001-S',
      'membrane-cell-ch2010':      'CH2010 · CH2010-S',
      'electrode-stand-t0101':       'T0101',
      'cell-c040':                   'C040 · C040-S',
      'multifunction-cell-m005':     'M005 · M005-S',
      'h-cell-ch2003':               'CH2003 · CH2003-T · CH2004',
      'membrane-cell-ch2015':        'CH2015-S · CH2016-S',
      'photo-cell-k040':             'K040 · K040-S · K045 · K045-S',
      'photo-reactor-k010':          'K010 · K011',
      'photo-cell-k020':             'K020',
      'photo-cell-k050':             'K050 · K051',
      'spectro-cell-k003':           'K003',
      'flat-cell-f029':              'F029 · F030',
      'corrosion-cell-f500':         'F500',
      'coating-cell-f011':           'F011 · F005',
      'double-flat-cell':            '양면 대향',
      'raman-cell-k004':             'K004 · K005 · K006 · K008',
      'raman-battery-cell':          'E702 ~ E705',
      'xrd-cell-e602':               'E602A · D2 · D8 · mini',
      'zinc-air-cell-e100':          'E100 · E100-S · E100K · E100K-S · E100L',
      'battery-imaging-e001':        'E001',
      'battery-observation-e003':    'E003',
      'gde-cell-e023':               'E023',
      'half-cell-e025':              'E025',
      'battery-cell-e200':           'E200'}
