...
SRC={p['slug']:p for p in json.load(open(os.path.join(ROOT,'_ops/runze/runze_batch145.json'),encoding='utf8'))}
META=json.load(open(os.path.join(ROOT,'_ops/runze/img_meta.json'),encoding='utf8'))
